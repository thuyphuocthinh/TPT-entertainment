...
const controller = __importStar(require("../../controllers/admin/settings.controller"));
...
router.patch("/edit/:id", requestMiddleware.patchReq("settings"), upload.single("image"), uploadCloudinary.uploadSingle, controller.patchEdit);
